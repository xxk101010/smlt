...
#define  Device_Channel_Number    6
...
typedef struct _Device_Obj_Mage
{
	...
	uint32_t   Device_Switch_On_Delay_Ct;         // 延时开计数器
	
	uint32_t   Device_Switch_Off_Delay_Ct;         // 延时关计数器
...
extern Device_Obj_Mage_t   Device_Obj_Mage[Device_Channel_Number];

extern uint16_t  g_Device_Zero_EXTI_Ct;

extern uint8_t g_device_state;

extern smlt_engine_t *smlt_handle;
