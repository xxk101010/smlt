...
Device_Obj_Mage_t   Device_Obj_Mage[Device_Channel_Number];
...
smlt_engine_t *smlt_handle = NULL;

void Device_Intial(void)
{
	
	smlt_handle = (smlt_engHandle_t)smlt_engine_new(NULL);
   ...
   // AT24CXX_Read(AT24C64_ADDR,IIC_DEV_ADDR_TYPE_1,0,(uint8_t *)&Device_Set_Pra.Memmory_1.Device_Type,sizeof(Device_Set_Pra_t)); 
	}
	
	
//	 preset_save_ptr =  (preset_save_t*)&Device_Set_Pra.Memmory_35.reserve_16[0];
}
...
{	
	...
	{
//		Device_Obj_Mage[physic_channel].Switch_drive_state=Switch_drive_On_set;
...
//						if(device_level<Device_Set_Pra.Memmory_12.Device_Switch_Level[i])  
//						{
